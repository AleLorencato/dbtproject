with prod as (
    select 
    ct.category_name, sp.company_name as suppliers, pd.product_name, pd.unit_price, pd.product_id
    ...
    select ord.order_date, ord.order_id, cs.company_name as customer, em.name as employee, em.age, em.lengthservice
    ...
    select od.*, ord.order_date, ord.customer, ord.employee, ord.age, ord.lengthservice
    from orddetai od
